			...
			<div class="block-content collapse in">
				<div class="span12">
					<form class="form-horizontal"
						action="<c:url value='/medico/editar'/>" method="post">
						<fieldset>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6"
										...
										value="${medico.pessoaFisica.nome}">
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<select name="medico.pessoaFisica.sexo" id="sexo" class="span6">
										<option value="${medico.pessoaFisica.sexo}"
											selected="selected">${medico.pessoaFisica.sexo}</option>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6 telefone"
										...
										value="${medico.pessoaFisica.telefone}">
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6 telefone"
										...
										value="${medico.pessoaFisica.celular}">
								</div>
							</div>
