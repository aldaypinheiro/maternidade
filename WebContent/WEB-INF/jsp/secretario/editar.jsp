			...
			<div class="block-content collapse in">
				<div class="span12">
					<form class="form-horizontal" method="post"
						...
						<fieldset>
							<legend>Alterar secret&aacute;rio</legend>
							<legend>Dados Pessoais</legend>
							<input type="hidden" name="id" value="${secretario.id}">
							<input type="hidden" name="idUsuario" value="${secretario.idUsuario}">
							<div class="control-group">
								<label class="control-label" for="nome">Nome </label>
								<div class="controls">
									<input type="text" class="span6"
										name="secretario.pessoaFisica.nome" value="${secretario.pessoaFisica.nome}" id="nome">
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="sexo">Sexo </label>
								<div class="controls">
									<select class="span6" name="secretario.pessoaFisica.sexo" id="sexo">
										<option selected="selected" value="${secretario.pessoaFisica.sexo}">${secretario.pessoaFisica.sexo}</option>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6 cpf"
										name="secretario.pessoaFisica.cpf" value="${secretario.pessoaFisica.cpf}" id="cpf">
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6 telefone"
										name="secretario.pessoaFisica.telefone" value="${secretario.pessoaFisica.telefone}" id="telefone">
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6 telefone"
										name="secretario.pessoaFisica.celular" value="${secretario.pessoaFisica.celular}" id="celular">
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6"
										name="secretario.pessoaFisica.endereco.rua" value="${secretario.pessoaFisica.endereco.rua}" id="logradouro">
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6"
										name="secretario.pessoaFisica.endereco.numero" value="${secretario.pessoaFisica.endereco.numero}" id="numero">
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6"
										...
										value="${secretario.pessoaFisica.endereco.complemento}" id="complmento">
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6 cep"
										name="secretario.pessoaFisica.endereco.cep" value="${secretario.pessoaFisica.endereco.cep}" id="cep">
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6"
										name="secretario.pessoaFisica.endereco.bairro" value="${secretario.pessoaFisica.endereco.bairro}" id="bairro">
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									...
									<option value="${secretario.pessoaFisica.endereco.cidade.estado.id}" selected="selected">${secretario.pessoaFisica.endereco.cidade.estado.nome}
											(${secretario.pessoaFisica.endereco.cidade.estado.sigla})</option>
							...
							<div class="control-group">
								...
								<div class="controls">
									...
									<option value="${secretario.pessoaFisica.endereco.cidade.id}"
											selected="selected">${secretario.pessoaFisica.endereco.cidade.nome}</option>
