			...
			<div class="block-content collapse in">
				<div class="span12">
					<form class="form-horizontal" method="post"
						action="<c:url value='/secretario/cadastrar'/>">
						<fieldset>
							<legend>Cadastrar novo secret&aacute;rio</legend>
							<legend>Dados Pessoais</legend>
							<div class="control-group">
								<label class="control-label" for="nome">Nome </label>
								<div class="controls">
									<input type="text" class="span6"
										name="secretario.pessoaFisica.nome" id="nome">
								</div>
							</div>
							<div class="control-group">
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6 cpf"
										name="secretario.pessoaFisica.cpf" id="cpf">
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6 telefone"
										name="secretario.pessoaFisica.telefone" id="telefone">
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6 telefone"
										name="secretario.pessoaFisica.celular" id="celular">
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6"
										name="secretario.pessoaFisica.endereco.rua" id="logradouro">
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6"
										name="secretario.pessoaFisica.endereco.numero" id="numero">
								</div>
							</div>
							<div class="control-group">
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6 cep"
										name="secretario.pessoaFisica.endereco.cep" id="cep">
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6"
										name="secretario.pessoaFisica.endereco.bairro" id="bairro">
								</div>
							</div>
							<div class="control-group">
