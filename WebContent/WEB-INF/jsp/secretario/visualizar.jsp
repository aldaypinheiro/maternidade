							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6" name="idUsuario"
										value="${secretario.idUsuario}" id="idUsuario"
										disabled="disabled">
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6"
										...
										value="${secretario.pessoaFisica.nome}" id="nome"
										disabled="disabled">
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<select class="span6" name="secretario.pessoaFisica.sexo"
										...
										<option selected="selected"
											value="${secretario.pessoaFisica.sexo}">${secretario.pessoaFisica.sexo}</option>
									</select>
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6"
										...
										value="${secretario.pessoaFisica.cpf}" id="cpf"
										disabled="disabled">
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6"
										...
										value="${secretario.pessoaFisica.telefone}" id="telefone"
										disabled="disabled">
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6"
										...
										value="${secretario.pessoaFisica.celular}" id="celular"
										disabled="disabled">
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6"
										...
										value="${secretario.pessoaFisica.endereco.rua}"
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6"
										...
										value="${secretario.pessoaFisica.endereco.numero}" id="numero"
										disabled="disabled">
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6"
										...
										value="${secretario.pessoaFisica.endereco.complemento}"
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6"
										...
										value="${secretario.pessoaFisica.endereco.cep}" id="cep"
										disabled="disabled">
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6"
										...
										value="${secretario.pessoaFisica.endereco.bairro}" id="bairro"
										disabled="disabled">
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<select class="span6" name="estado" id="estado"
										disabled="disabled">
										<option
											value="${secretario.pessoaFisica.endereco.cidade.estado.id}"
											selected="selected">${secretario.pessoaFisica.endereco.cidade.estado.nome}
