			...
			<div class="block-content collapse in">
				<div class="span12">
					<form class="form-horizontal" method="post"
						action="<c:url value='/diretor/cadastrar'/>">
						<fieldset>
							<legend>Cadastrar novo diretor</legend>
							<legend>Dados Pessoais</legend>
							<div class="control-group">
								<label class="control-label" for="nome">Nome </label>
								<div class="controls">
									<input type="text" class="span6"
										name="diretor.pessoaFisica.nome" id="nome">
								</div>
							</div>
							<div class="control-group">
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6 cpf"
										name="diretor.pessoaFisica.cpf" id="cpf">
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6 telefone"
										name="diretor.pessoaFisica.telefone" id="telefone">
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6 telefone"
										name="diretor.pessoaFisica.celular" id="celular">
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6"
										name="diretor.pessoaFisica.endereco.rua" id="logradouro">
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6"
										name="diretor.pessoaFisica.endereco.numero" id="numero">
								</div>
							</div>
							<div class="control-group">
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6 cep"
										name="diretor.pessoaFisica.endereco.cep" id="cep">
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6"
										name="diretor.pessoaFisica.endereco.bairro" id="bairro">
								</div>
							</div>
							<div class="control-group">
