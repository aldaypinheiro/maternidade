			...
			<div class="block-content collapse in">
				<div class="span12">
					<form class="form-horizontal"
						action="<c:url value='/bebe/cadastrar'/>" method="post">
						<fieldset>
							<legend>cadastrar novo beb&ecirc;</legend>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input class="input-xlarge focused" id="bebe.nascimento"
										type="date" name="nascimento" value="">
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="bebe.peso">Peso (kg)</label>
								<div class="controls">
									<input class="input-xlarge focused peso" id="bebe.peso" type="text"
										name="bebe.peso" value="">
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="bebe.altura">Altura (cm)</label>
								<div class="controls">
							...
							<div class="control-group">
								...
								<div class="controls">
									<input class="input-xlarge focused telefone" id="bebe.genitor1.celular"
										type="text" name="bebe.genitor1.celular" value="">
								</div>
							</div>
							<div class="control-group">
							...
							<div class="control-group">
								...
								<div class="controls">
									<input class="input-xlarge focused telefone" id="bebe.genitor2.celular"
										type="text" name="bebe.genitor2.celular" value="">
								</div>
							</div>
